...
class VEML6040(object):
    def __init__(self, freq=400000, sda=4, scl=14, addr = 0x10):
        self.i2c = I2C(freq=freq, sda=Pin(sda), scl=Pin(scl))
        self.addr = addr
        self.i2c.writeto_mem(self.addr, _CONF, _SHUTDOWN)
        self.i2c.writeto_mem(self.addr, _CONF, _DEFAULT_SETTINGS)
        sleep_ms(50)
